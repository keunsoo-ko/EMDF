...
from network.basic_module import FullyConnectedLayer, Conv2dLayer, MappingNet, MinibatchStdLayer, DisFromRGB, DisBlock, StyleConv, ToRGB, get_style_code
...
class SynthesisNet(nn.Module):
    ...
    def forward(self, images_in, masks_in, ws, noise_mode='random', return_stg1=False):
        ...
        # encoder
        x = torch.cat([masks_in - 0.5, images_in, images_in * masks_in], dim=1)
        ...
        # ensemble
        img = img.clamp(-1, 1) * (1 - masks_in) + images_in * masks_in
